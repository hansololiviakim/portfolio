...
export const projectList = [
  {
    ...
    features: [
      '<b>Node.js v14 → v20 업그레이드와 패키지 매니저(yarn → pnpm) 전환</b>을 전담해, 가상환경의 디스크 부족 이슈를 해결하고 <b>로컬 빌드 시간을 5분에서 1분 40초로 67% 단축</b>했습니다.',
      '전기차 신규 모델 추가 및 현대자동차 임직원 전용 캐스퍼 구매서비스 구축 프로젝트에서 <b>전기차 보조금·세제 혜택·직원 할인 기능 개발을 전담</b>했습니다.',
  ...
  },
  {
    ...
    features: [
      '플레이스(식당 리스트) 페이지의 전체 구조를 설계하고, <b>리스트-카카오맵 연동, 커스텀 마커 및 오버레이 기능</b>을 구현했습니다.',
      '<b>가로 스크롤 및 드래그(터치/마우스) 기능을 지원하는 커스텀 훅</b>을 개발해 PC와 모바일 모두 일관된 사용자 경험을 제공했습니다.',
      '이전 사이드프로젝트에서 개발 컨벤션과 문서화가 부족했던 경험을 바탕으로, <b>AI 코드 리뷰 연동</b>을 통한 코드 품질 관리와 <b>GitHub Projects, Issues, PR을 활용한 문서화 프로세스</b>를 구축하여 팀원 간 개발 현황 공유와 협업 효율성을 크게 개선했습니다.',
    ],
  },
  {
    id: 2,
    ...
    features: [
      '<b>CSS transform</b>을 활용해 사용자 액션에 따라 동적으로 회전하는 애니메이션 룰렛을 구현했습니다. <b>룰렛에는 가중치 기반 확률 알고리즘을 적용하여 옵션 별 등장 확률을 세밀하게 조정</b>했습니다.',
      '3개월 운영 기간 동안 <b>전체 순 방문자(UV) 대비 49%의 회원 전환율</b>을 달성했으며, 홍보 및 광고 집행, UX 분석 툴 연동, 기술 아티클 작성 등 개발 외적인 마케팅 및 <b>운영 경험</b>도 쌓을 수 있었습니다.',
      'IT 프로덕트 커뮤니티 디스콰이엇에서 출시 하루 만에 <b>위클리 프로덕트 1위</b>를 달성했으며, 게시한 팀 협업 후기가 뉴스레터에 소개되었습니다.',
    ],
  },
  {
    id: 3,
    ...
    features: [
      '<b>900개 데이터에 무한 스크롤·이미지 Lazy Loading</b>을 적용해 성능을 개선하고, Lighthouse 성능 점수는 60점에서 80점, 검색엔진 최적화 점수는 85점으로 향상시켰습니다.',
