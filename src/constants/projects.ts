...
export const projectList = [
  {
    ...
    desc: '현대자동차 최초 온라인 판매 차량인 캐스퍼의 웹 플랫폼 운영과 신규 모델 프로젝트에 참여했습니다.\nUI/UX 개선, 신규 모델 런칭을 위한 견적 및 계약 로직 구축 등 전반적인 프론트엔드 개발 업무를 수행했습니다.',
    ...
    features: [
      ...
      '일렉트릭 모델 및 임직원 구매서비스 프로젝트에서 <b>전기차 보조금·세제 혜택·직원 할인 기능 개발을 전담</b>했습니다.',
  ...
  },
  {
    ...
    // desc: '하루 중 가장 많은 시간을 보내는 ‘회사 생활’에 도움이 되는 프로덕트를 만들고 싶었습니다.\n키링은 회사 근처 식당 리스트, 교통 정보, 캘린더, 커뮤니티 기능을 하나로 모은 올인원 웹앱입니다.',
    ...
    features: [
      ...
      '플레이스 페이지에 레스토랑 리스트 데이터 필더링과 페이지네이션을 적용하였고,<br /><b>카카오맵을 연동하여 지도 중심 이동에 따른 데이터 호출 및 마커/오버레이 커스텀</b> 기능을 구현했습니다.',
      '<b>react-calendar를 기반 캘린더 페이지</b>를 제작하고, 로그인 및 날짜별 데이터에 따라 동적 UI를 구현했습니다.',
      '<b>파이썬 크롤러를 직접 개발</b>해 네이버맵 기준 회사 근처 식당 300여 개의 데이터를 자동 수집했습니다.',
    ],
  },
  {
    id: 2,
