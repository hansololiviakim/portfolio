...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      width: generateUtilities(1100),
      minWidth: generateUtilities(1100),
      maxWidth: generateUtilities(1100),
      height: generateUtilities(1100),
      minHeight: generateUtilities(1100),
      maxHeight: generateUtilities(1100),
